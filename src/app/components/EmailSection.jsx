...
const EmailSection = () => {
  ...
  return (
    <section
      id="contacts"
      className="grid md:grid-cols-2 my-12 md:my-12 lg:py-28 gap-4 relative sm: py-2 sm:my-4"
    >
        ...
        <form ref={formRef} className="flex flex-col" onSubmit={handleSubmit}>
          ...
          <div className="mb-2">
            ...
            <textarea
              name="message"
              id="message"
              className="bg-[#18191E] min-h-[45px] max-h-[200px] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
